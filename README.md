# Continuous Integration ![https://github.com/derikkk/continuous-integration/actions?query=workflow%3Atests](https://github.com/derikkk/continuous-integration/workflows/tests/badge.svg)
